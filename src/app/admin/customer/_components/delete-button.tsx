...
import { customerDeleteAction } from "@/actions/customer-action";
...
export default function DeleteButton({ customerId }: DeleteButtonProps) {
  const [open, setOpen] = useState(false);
  const handleDelete = async () => {
    const res = await customerDeleteAction(customerId);
    if (res.success) {
